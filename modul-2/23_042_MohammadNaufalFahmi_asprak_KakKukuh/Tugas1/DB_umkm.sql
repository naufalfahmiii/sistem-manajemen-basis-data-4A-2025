...
ADD CONSTRAINT unique_nik UNIQUE (nik);
...
INSERT INTO pemilik_umkm (nik, nama_lengkap, jenis_kelamin, alamat, nomor_telepon, email) VALUES
('3211014406870067', 'THerta', 'Perempuan', 'Jl. Anggrek No. 76, Tasikmalaya', '087890123098', 'Therta@gmail.com');
...
JOIN kategori_umkm ku ON u.id_kategori = ku.id_kategori
...
SELECT * FROM pemilik_umkm WHERE id_pemilik = 15;
ALTER TABLE pemilik_umkm AUTO_INCREMENT = 15;
INSERT INTO pemilik_umkm (nik, nama_lengkap, jenis_kelamin, alamat, nomor_telepon, email) VALUES ('3211014406870015', 'Eko Susanto', 'Laki-laki', 'Jl. Anggrek No. 76, Tasikmalaya', '087890123456', 'eko.susanto@gmail.com');
